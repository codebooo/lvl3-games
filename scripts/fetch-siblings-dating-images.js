...
const PAIRS = [
  // ── Geschwister — NUR gemischtgeschlechtlich (Bruder & Schwester), damit die
  //    Ähnlichkeit nicht sofort verrät, dass es Geschwister sind ──
  ["siblings", "Bruder & Schwester",        "Jake Gyllenhaal", "Maggie Gyllenhaal"],
  ["siblings", "Bruder & Schwester",        "Warren Beatty", "Shirley MacLaine"],
  ["siblings", "Bruder & Schwester",        "Eric Roberts", "Julia Roberts"],
  ["siblings", "Bruder & Schwester",        "Jaden Smith", "Willow Smith"],
  ["siblings", "Bruder & Schwester",        "Jonah Hill", "Beanie Feldstein"],
  ["siblings", "Bruder & Schwester",        "Rob Kardashian", "Kim Kardashian"],
  ["siblings", "Bruder & Schwester",        "Anwar Hadid", "Gigi Hadid"],
  ["siblings", "Bruder & Schwester",        "Anwar Hadid", "Bella Hadid"],
  ["siblings", "Bruder & Schwester",        "Oliver Hudson", "Kate Hudson"],
  ["siblings", "Bruder & Schwester",        "Frankie Grande", "Ariana Grande"],
  ["siblings", "Bruder & Schwester",        "Prince Jackson", "Paris Jackson", "Prince Jackson (son of Michael Jackson)", "Paris Jackson"],
  ["siblings", "Bruder & Schwester",        "John Cusack", "Joan Cusack"],
  ["siblings", "Halbgeschwister",           "Brody Jenner", "Kendall Jenner"],
  ["siblings", "Bruder & Schwester",        "Trace Cyrus", "Miley Cyrus"],
  ["siblings", "Bruder & Schwester",        "Patrick Schwarzenegger", "Katherine Schwarzenegger"],
  ["siblings", "Bruder & Schwester",        "Timothée Chalamet", "Pauline Chalamet"],
  ["siblings", "Bruder & Schwester",        "Presley Gerber", "Kaia Gerber"],
  ["siblings", "Halbgeschwister",           "Brody Jenner", "Kylie Jenner"],
  // ── Paare ──
